            ...
            <section>
                ...
                <Tabs defaultValue="6h" onValueChange={(value) => setActiveTab(value)} >
                    ...
                    <TabsList className="flex items-center gap-4 mb-4">
                            <h1 className='font-semibold md:text-xl text-lg'>Hot collections</h1>
                            ...
                            <TabsTrigger value="All-time" isActive={activeTab === "All-time"} className="rounded-[20px]">All time</TabsTrigger>
                        </TabsList>
                    <Link>
