...
const CarouselPrevious = React.forwardRef(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    (<Button
      ...
      variant={variant}
      size={size}
      className={cn("absolute bg-secondary border-0 h-8 w-8 rounded-full", orientation === "horizontal"
...
const CarouselNext = React.forwardRef(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    (<Button
      ...
      variant={variant}
      size={size}
      className={cn("absolute h-8 w-8 bg-secondary border-0 rounded-full", orientation === "horizontal"
